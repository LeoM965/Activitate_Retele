            ...
            try:
                ...
                # File operations
                    ...
                    if os.path.exists(old_path):
                        ...
                        log_operation(old_name, f'renamed to {new_name}', current_user)
                        log_operation(new_name, f'renamed from {old_name}', current_user)
                    ...
                    try:
                        ...
                        response = {'status': 'success', 'history': file_history}
                        print(f" History requested for: {filename}")
                    except:
                        response = {'status': 'error', 'message': 'Could not read history'}
